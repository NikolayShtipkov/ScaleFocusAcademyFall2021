...
namespace ProjectManagementApp.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(UserService userService, TeamService teamService) : base()
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> EditUserAsync(int id, UserEditRequestDTO userEdit)
        {
            var currentUser = _userService.GetCurrentUser(Request);
            if (currentUser == null)
            {
